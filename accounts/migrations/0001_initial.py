    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('permissions', models.ManyToManyField(blank=True, help_text='Individual permission(s) for this employee', to='accounts.Permission')),
                ('roles', models.ManyToManyField(blank=True, help_text='Role(s) of this employee.', to='accounts.Role')),
                ('team', models.ForeignKey(help_text='Team in which this employee belongs to.', on_delete=django.db.models.deletion.PROTECT, to='accounts.team')),
            ],
            options={
                'verbose_name': 'user',
